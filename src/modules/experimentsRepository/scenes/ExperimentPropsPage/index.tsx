          ...
          <div className="container">
            <div className="box ">
              ...
              <table className="table">
                <tbody>
                  <tr><th>Status</th><td>{currentExperiment.status}</td></tr>
                  <tr><th>Inserted</th><td>{moment(currentExperiment.inserted).format("YYYY/MM/DD HH:mm")}</td></tr>
                  <tr><th>Started</th><td>{moment(currentExperiment.started).format("YYYY/MM/DD HH:mm")}</td></tr>
                </tbody>
              </table>
            </div>
          </div>
        ...
        <section className="section">
          <div className="container">
            <div className="columns is-tablet">
              {currentExperiment.experimentRelation && <div className="column">
                <div className="box">
                  <h4 className="title is-4">Experiments</h4>
                </div>
              </div>}
              {currentExperiment.bioQuantities && <div className="column">
                <div className="box">
                  <h4 className="title is-4">Bioquantities</h4>
                </div>
              </div>}
              {currentExperiment.experimentModels && <div className="column">
                <div className="box">
