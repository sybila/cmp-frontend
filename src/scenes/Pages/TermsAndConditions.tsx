...
const TermsAndConditions = () => {
  return (
    <div>
      ...
      <h2>Welcome to Comprehensive Modelling Platform reffered as CMP</h2>
      <p>
        These terms and conditions outline the rules and regulations for the use
        of https://new.e-cyanobacterium.org/ Website.
      </p>
      <p>
        By accessing this website we assume you accept these terms and
        conditions in full. Do not continue to use CMP's website if you do not
      ...
      <h2>Cookies</h2>
      <p>
        We employ the use of cookies. By using CMP's website you consent to the
        use of cookies in accordance with CMP’s privacy policy.
      </p>
      <p>
      ...
      <h2>License</h2>
      <p>
        Unless otherwise stated, CMP and/or it’s licensors own the intellectual
        property rights for all material on CMP. All intellectual property
        rights are reserved. You may view and/or print pages from
        https://new.e-cyanobacterium.org/ for your own personal use subject to
        restrictions set in these terms and conditions.
      </p>
      <p>You must not:</p>
      <ol type="1">
        <li>Republish material from https://new.e-cyanobacterium.org/</li>
        <li>
      ...
      <p>
        Redistribute content from CMP (unless content is specifically made for
        redistribution).
      </p>
      ...
      <p>
        ...
        e-mail to ecyano@fi.muni.cz. Please include your name, your organization
      ...
      <p>
        No use of CMP’s logo or other artwork will be allowed for linking absent
      ...
      <p>
        Data files contained in the CMP database (models, experiments,
        annotation data, experimenatal values) are free of all copyright
        restrictions and made fully and freely available for both non-commercial
        and commercial use. Users of the data should attribute the original
        authors of that structural dat.
      </p>
    </div>
  );
};
